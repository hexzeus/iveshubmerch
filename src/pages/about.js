...
const TermsPage = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-900 via-black to-gray-900 px-6 py-12">
      <div className="max-w-4xl mx-auto p-8 bg-gray-800 shadow-2xl rounded-lg">
