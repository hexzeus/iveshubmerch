  ...
  return (
    <div className="bg-gradient-to-r from-gray-900 via-black to-gray-900 min-h-screen flex flex-col items-center justify-center">
      <div className="w-full max-w-3xl sm:max-w-4xl px-4 py-8 sm:py-12 md:py-16 text-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
          Your Wishlist
        </h1>
      </div>
      ...
      {hasItems ? (
        ...
        <p className="text-center text-gray-400 text-xl sm:text-2xl md:text-3xl">
          Your list is empty.
        </p>
      )}
    </div>
